...
```json
{
   ...
   "parentChain":{
      "S52.11":{
         ...
         "additionalCodes":{
            "code to identify any retained foreign body, if applicable (Z18.-)":"code to identify any retained foreign body, if applicable (Z18.-)"
         }
      },
      "S52.1":{
         "code":"S52.1",
         ...
         "excludes2":{
            "physeal fractures of upper end of radius (S59.2-)":"physeal fractures of upper end of radius (S59.2-)",
            "fracture of shaft of radius (S52.3-)":"fracture of shaft of radius (S52.3-)"
         },
         "inclusionTerms":[
      ...
      "S52":{
         ...
         "excludes1":{
            "traumatic amputation of forearm (S58.-)":"traumatic amputation of forearm (S58.-)"
         },
         "excludes2":{
            "fracture at wrist and hand level (S62.-)":"fracture at wrist and hand level (S62.-)"
         },
         "sevenCharacterNote":"The appropriate 7th character is to be added to all codes from category S52",
         "sevenCharacterDefinitions":{
            "A":"initial encounter for closed fracture",
      ...
      "S50-S59":{
         ...
         "excludes2":{
            "burns and corrosions (T20-T32)":"burns and corrosions (T20-T32)",
            "frostbite (T33-T34)":"frostbite (T33-T34)",
            "injuries of wrist and hand (S60-S69)":"injuries of wrist and hand (S60-S69)",
            "insect bite or sting, venomous (T63.4)":"insect bite or sting, venomous (T63.4)"
         },
         "additionalCodes":{
            "code to identify any retained foreign body, if applicable (Z18.-)":"code to identify any retained foreign body, if applicable (Z18.-)"
         }
      ...
      "19":{
         ...
         "excludes1":{
            "birth trauma (P10-P15)":"birth trauma (P10-P15)",
            "obstetric trauma (O70-O71)":"obstetric trauma (O70-O71)"
         },
         "additionalCodes":{
            "code to identify any retained foreign body, if applicable (Z18.-)":"code to identify any retained foreign body, if applicable (Z18.-)"
         }
